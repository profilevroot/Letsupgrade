...
export function TableDataClient<TData, TValue>({
  columns,
  apiUrl,
  actions,
  appUrl,
  ...
  const sno = pageIndex ? pageIndex * pageSize : 0;
  const permissionColumns = columns({
    actions,
    appUrl,
    apiUrl,
    sno,
 ...
 */
  return (
    <>
      ...
      /> */}
      <ScrollArea className="rounded-sx border h-[calc(90vh-120px)]">

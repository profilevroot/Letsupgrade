...
-- AddForeignKey
ALTER TABLE "Organizations" ADD CONSTRAINT "Organizations_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "Organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
